...
uint256 hashGenesisBlock("0x49393851d7a2db1a23ee63a4ebe27c96504e0c54310429278aca8d7a1b9be6ec");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xceaaf415ed8718afa860d1a78655fb024063fb0d0de3e6343f94a2d5cec2d05b");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "10/10/2022 - Recyclecoin hits over a million views!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 25 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("049e38aaa2b40290917e6b3c9647aff76fa90c29083a9658fb780a0280991ea20e9ce17d07f83ae147e54604bad759274317146e744325116678a0534671a3bb25") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1665397332;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085855304;

        if (fTestNet)
        {
            block.nTime    = 1665397280;
            block.nNonce   = 385292558;
        }
...
if (true && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xa3a3fb7ccd2ed65b619cc619d536c01cf20ff924e796b2249611134d99c1b846"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfd, 0xc3, 0xb1, 0xde }; // Recyclecoin: increase each by adding 2 to bitcoin's value.
